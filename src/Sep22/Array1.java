...
import java.util.*;
	public class Array1
	{
		...
		public static void column()
		{
			...
			{
				System.out.println("We have only "+a.length+" columns So please enter below "+(a.length));
				column();
			}
		}
		public static void row()
		{
			...
			{
				System.out.println("We have only "+a.length+" rows So please enter below "+(a.length));
				row();
			}
		}
